...
class SparkEnvConfiger:
    _basic = {
        ...
        "spark.sql.defaultCatalog": ("SPARGLIM_SQL_DEFAULT_CATALOG", "lakehouse"),
        ...
        "spark.network.timeout": ("SPARGLIM_NETWORK_TIMEOUT", "400000"),
        "spark.executorEnv.AWS_REGION": ("AWS_REGION", "us-east-1"),
        "spark.executorEnv.AWS_ACCESS_KEY_ID": ("AWS_ACCESS_KEY_ID", "admin"),
